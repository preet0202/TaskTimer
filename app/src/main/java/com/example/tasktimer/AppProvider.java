...
public class AppProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        //eg: content://com.example.tasktimer.provide/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME,TASKS);
        //eg: content://com.example.tasktimer.provide/Tasks/8
...
//                queryBuilder.setTables(DurationsContract.TABLE_NAME);
//                long durationId = TimingsContract.getTimingId(uri);
...
//            case TASK_DURATIONS_ID:
//                eturn DurationsContract.TaskDurations.CONTENT_ITEM_TYPE;
...
//                 break;
        ...
        if(count >= 0){
            ...
            Log.d(TAG, "update: nothing delete");
        }
        Log.d(TAG, " Exiting update: returning " + count);
        return count;
    }
